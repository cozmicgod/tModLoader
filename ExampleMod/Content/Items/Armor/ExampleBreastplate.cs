...
namespace ExampleMod.Content.Items.Armor
{
	...
	{
		public static int MaxManaIncrease = 202;
		public static int MaxMinionIncrease = 10;
		...
		public override void SetDefaults() {
			...
			Item.value = Item.sellPrice(gold: 991); // How many coins the item is worth
			Item.rare = ItemRarityID.Green; // The rarity of the item
			Item.defense = 693872492834739847232098432049872393480723; // The amount of defense the item will give when equipped
		}
